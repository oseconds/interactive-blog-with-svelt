...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<h2 class="h2">공사중입니다</h2>
		<!-- 유튜브 영상 임베드 -->
		<div class="video-container">
            <iframe width="500" height="300" src="https://www.youtube.com/embed/iKJOuc8cZf4" title="0Seconds: MASIO | Seoul Community Radio" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
		...
		<div class="space-y-2">
			<p>최근 p5.js:</p>
			<a href="https://oseconds.github.io/Particle_System_with_Repeller_2023_11_21_04_56_53/">
				<p><code class="code">Particle_System_with_Repeller</code></p>
			</a>
			<a href="https://oseconds.github.io/Particle_distance/">
				<p><code class="code">Particle_distance</code></p>
			</a>
		</div>
	</div>
</div>
